...
set CLASSPATH=%APP_HOME%\lib\my-app-1.0-SNAPSHOT.jar

@rem Execute my-app
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MY_APP_OPTS%  -classpath "%CLASSPATH%" com.mycompany.app.App %CMD_LINE_ARGS%
